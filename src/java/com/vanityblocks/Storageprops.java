...
public class Storageprops {
	public static void initProps(File configBase) {
		...
		marblerarity = config
				.get(category5,
						"Rarity- How often should marble generate in a chunk, good value is below 10",
						1).getInt();
		...
		blackmarblerarity = config
				.get(category6,
						"Rarity- How often should black marble generate in a chunk, good value is below 10",
						1).getInt();
		...
		gadrarity = config
				.get(category9,
						"Rarity- How often should stone generate in a chunk, good value is below 10",
						8).getInt();

		String category10 = "Random vanity blocks";
		enablerandomblocks = config.get(category10, "Enable the random blocks?",
				true).getBoolean(true);
		enableclaybrick = config.get(category10, "Enable clay brick crafting",
				true).getBoolean(true);
		enableoldlapisblock = config.get(category10,
				"Enable crafting for block with old lapis texture(2x2 lapis)",
				true).getBoolean(true);
		enablewhitesoulsand = config.get(category10,
				"Enable white soul sand crafting?", true).getBoolean(true);
		enablewhitesoulsandspeed = config.get(category10,
				"Enable the white soul sand speed boost?", true).getBoolean(
				true);

		String category11 = "Random texture Related";
	...
	public static int vanityworldgraniteconfig;
	public static int vanityworlddioriteconfig;
	public static int vanityworldandesiteconfig;
	public static int vanitydesignworldslabconfig;
	public static int vanitydesignworldWallconfig;
	public static int stonepolishitem;
	...
	public static int gadrange;
	public static int gadvein;
	public static int gadrarity;
